...
export const translations = {
    tr: {
        ...
        // Admin Panel i18n
        adminModalTitle: "RUH Project - Sistem Yönetici & Kayıt Kontrol Paneli",
        adminStatUsers: "TOPLAM KAYITLI KULLANICI",
        adminStatCerts: "TESCİLLİ SERTİFİKA SAYISI",
        adminStatPhone: "DOĞRULANMIŞ TELEFONLAR",
        adminStatDonations: "TOPLAM BAĞIŞ TUTARI",
        phAdminSearch: "Kayıtlarda Ara (Ad, E-posta, TC, Enerji ID, Barkod...)",
        btnAdminExportCsv: "CSV Olarak İndir",
        btnAdminResetAll: "Tüm Kayıtları Sıfırla",
        thAdminName: "Ad Soyad",
        thAdminEmail: "E-posta",
        thAdminPhone: "Telefon",
        thAdminIdentity: "TC / Pasaport",
        thAdminEnergyId: "Enerji ID",
        thAdminBarcode: "Barkod No",
        thAdminInheritance: "Miras Escrow",
        thAdminDate: "Kayıt Tarihi",
        thAdminActions: "İşlemler",
        adminFooterNotice: "R.U.H. Incorporation Yüksek Güvenlikli Yönetici Paneli",
        navAdminBtn: "Admin Paneli",
        ...
        lblCreatePassword: "Kullanıcı Şifresi Oluştur *",
        lblConfirmPassword: "Şifreyi Tekrar Girin *",
    ...
    en: {
        ...
        // Admin Panel i18n (EN)
        adminModalTitle: "RUH Project - System Admin & Registration Control Panel",
        adminStatUsers: "TOTAL REGISTERED USERS",
        adminStatCerts: "REGISTERED CERTIFICATES",
        adminStatPhone: "VERIFIED PHONE NUMBERS",
        adminStatDonations: "TOTAL DONATION POOL",
        phAdminSearch: "Search Registrations (Name, Email, ID, Energy ID, Barcode...)",
        btnAdminExportCsv: "Export to CSV",
        btnAdminResetAll: "Reset All Test Logs",
        thAdminName: "Full Name",
        thAdminEmail: "Email",
        thAdminPhone: "Phone",
        thAdminIdentity: "ID / Passport",
        thAdminEnergyId: "Energy ID",
        thAdminBarcode: "Barcode No",
        thAdminInheritance: "Inheritance Escrow",
        thAdminDate: "Date",
        thAdminActions: "Actions",
        adminFooterNotice: "R.U.H. Incorporation High Security System Admin Panel",
        navAdminBtn: "Admin Panel",
        ...
        lblCreatePassword: "Create Account Password *",
